...
export const FormRowContent = styled.div.attrs({className: 'mb-4'})`
`;

export const RowLable = styled.label.attrs({className: 'font-semibold mb-0 text-lg'})`
`

export const InputWrapper = styled.div.attrs({className: 'w-full relative table border-collapse'})`
    input {
        padding: 0;
        border: none;
        border-radius: 0;
