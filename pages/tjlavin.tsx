...
export const TopSectionSubTitle = styled.div.attrs({
  className: "font-semibold leading-normal mb-15 text-tiny-2"
})`
  color: #4d4d4d;
`;
...
export const BodyWrapper = styled.div.attrs({
    className: "mt-0 pt-70 mt-0 pt-70"
  })`
`;
...
export const BodyRow = styled.div.attrs({
  className: "-mx-15 flex px-15 m-lg:flex m-lg:flex-col min-h-1"
})`
...
export const TopSectionLeftContainer = styled.div.attrs({
  className: "m-md:m-auto max-h-280"
})`
  img {
    width: 100%;
    border-radius: 10px;
