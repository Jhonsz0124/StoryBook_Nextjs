...
export const SubmitBtn = styled.div.attrs({
...
`
export const RowLable = styled.label.attrs({
    className: 'text-xl font-semibold mb-0'
})`
`
export const FormRowContent = styled.div.attrs({
    className: 'mb-15'
})`
`
export const FormDesc = styled.div.attrs({
    className: 'mb-100'
})`
`
...
`
export const BodyRowContent = styled.div.attrs({
